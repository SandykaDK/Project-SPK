                    ...
                    <form id="alternatifForm" action="{{ route('updatealternatif', $alternatif->id) }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="k1" name="k1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg" required>
                                <option value="1" {{ $alternatif->k1 == 1 ? 'selected' : '' }}>1</option>
                                <option value="2" {{ $alternatif->k1 == 2 ? 'selected' : '' }}>2</option>
                                <option value="3" {{ $alternatif->k1 == 3 ? 'selected' : '' }}>3</option>
                                <option value="4" {{ $alternatif->k1 == 4 ? 'selected' : '' }}>4</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="k2" name="k2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg" required>
                                <option value="1" {{ $alternatif->k2 == 1 ? 'selected' : '' }}>1</option>
                                <option value="2" {{ $alternatif->k2 == 2 ? 'selected' : '' }}>2</option>
                                <option value="3" {{ $alternatif->k2 == 3 ? 'selected' : '' }}>3</option>
                                <option value="4" {{ $alternatif->k2 == 4 ? 'selected' : '' }}>4</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="k3" name="k3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg" required>
                                <option value="1" {{ $alternatif->k3 == 1 ? 'selected' : '' }}>1</option>
                                <option value="2" {{ $alternatif->k3 == 2 ? 'selected' : '' }}>2</option>
                                <option value="3" {{ $alternatif->k3 == 3 ? 'selected' : '' }}>3</option>
                                <option value="4" {{ $alternatif->k3 == 4 ? 'selected' : '' }}>4</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="k4" name="k4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg" required>
                                <option value="1" {{ $alternatif->k4 == 1 ? 'selected' : '' }}>1</option>
                                <option value="2" {{ $alternatif->k4 == 2 ? 'selected' : '' }}>2</option>
                                <option value="3" {{ $alternatif->k4 == 3 ? 'selected' : '' }}>3</option>
                                <option value="4" {{ $alternatif->k4 == 4 ? 'selected' : '' }}>4</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="k5" name="k5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg" required>
                                ...
                                <option value="3" {{ $alternatif->k5 == 3 ? 'selected' : '' }}>3</option>
                                <option value="4" {{ $alternatif->k5 == 4 ? 'selected' : '' }}>4</option>
                            </select>
                        </div>
