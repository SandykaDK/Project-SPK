<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Jurusan S1 Sistem Informasi') }}
        </h2>
    </x-slot>
                                    ...
                                    @foreach ($mahasiswa as $index => $m)
                                        <tr class="hover:bg-gray-100 text-center">
                                            ...
                                            <td class="py-2 px-4 border-b border-gray-300">
                                                ...
                                                <a href="{{ route('editalternatif', ['id' => $m->id]) }}" class="btn-nilai bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mb-4">Nilai</a>
